...
const addUser = () => (
    <Formik
        ...
        validationSchema={Yup.object().shape({
            ...
            fldAddress: Yup.string('Please enter a valid fldAddress').max(25, "Please enter a valid fldAddress").required('Please enter your fldAddress'),
            fldEmail: Yup.string().email("Please enter a valid email").required("Please enter your email fldAddress"),
        ...
        render={({
            ...
            <fieldset className="formInput">
                <label className="formLabel">
                    Email:
                    <Field type="email" name="fldEmail"/>
