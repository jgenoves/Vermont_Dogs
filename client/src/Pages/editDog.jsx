    ...
    render() {
        return (
            <React.Fragment>
                ...
                {editDogForm(this.props.dogData.pmkDogId, this.props.dogData.fldName, this.props.dogData.fldBreed, this.props.dogData.fldAge,
                    this.props.dogData.fldDescription, this.props.dogData.fldPhoto, this.props.dogData.fldStatus)}
                {editTagsForm(this.props.tags, this.props.dogData.pmkDogId)}
                {deleteDog()}
                <Footer/>
            </React.Fragment>
        );
